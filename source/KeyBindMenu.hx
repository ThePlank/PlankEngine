...
class KeyBindMenu extends FlxSubState
{
	...
	override function create()
	{
		...
		keyTextDisplay.setFormat("Comic Sans MS Bold", 42, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		infoText.setFormat("Comic Sans MS Bold", 24, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
