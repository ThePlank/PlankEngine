...
// my decompile didint work
// https://github.com/AngelDTF/FNF-NewgroundsPort/blob/remaster/source/Controls.hx
	...
	public function fromSaveData(data, dev:Device)
	{
		...
		for (i in 0...buttons.length)
		{
			...
			if (keydata != null)
			{
				...
				{
					case Keys:
						bindKeys(buttons[i], keydata);
					case Gamepad(id):
						bindButtons(buttons[i], id, keydata);
				}
			}
		}
	}
