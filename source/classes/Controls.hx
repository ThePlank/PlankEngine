...
class Controls extends FlxActionSet
{
	...
	public var UP   (get, never):Bool; inline function get_UP   () return _note_up   .check();
	public var LEFT (get, never):Bool; inline function get_LEFT () return _note_left .check();
	public var RIGHT(get, never):Bool; inline function get_RIGHT() return _note_right.check();
	public var DOWN (get, never):Bool; inline function get_DOWN () return _note_down .check();

	public var UP_P   (get, never):Bool; inline function get_UP_P   () return _note_upP   .check();
	public var LEFT_P (get, never):Bool; inline function get_LEFT_P () return _note_leftP .check();
	public var RIGHT_P(get, never):Bool; inline function get_RIGHT_P() return _note_rightP.check();
	public var DOWN_P (get, never):Bool; inline function get_DOWN_P () return _note_downP .check();

	public var UP_R   (get, never):Bool; inline function get_UP_R   () return _note_upR   .check();
	public var LEFT_R (get, never):Bool; inline function get_LEFT_R () return _note_leftR .check();
	public var RIGHT_R(get, never):Bool; inline function get_RIGHT_R() return _note_rightR.check();
	public var DOWN_R (get, never):Bool; inline function get_DOWN_R () return _note_downR .check();
	...
	@:access(flixel.input.actions.FlxActionInput)
