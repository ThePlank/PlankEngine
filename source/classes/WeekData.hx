...
class WeekData {
	...
	public var unlockWeek:String;
	public var weekName:String;
	public var freeplayColors:Array<Int>;
	...
	public function new(weekFile:WeekFile) {
		...
		unlockWeek = weekFile.unlockWeek;
		weekName = weekFile.weekName;
		freeplayColors = weekFile.freeplayColors;
