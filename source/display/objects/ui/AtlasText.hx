...
{
	static var fonts = new Map<String, AtlasFontData>();
	static var casesAllowed = new Map<String, Case>();
	...
	public function new (x = 0.0, y = 0.0, text:String, fontName:String = AtlasFont.Default)
	{
