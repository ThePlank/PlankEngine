...
class MenuTypedItem extends MenuItem {
    ...
    @:isVar public var label(default, set):FlxSprite; 

    public function new(X:Int = 0, Y:Int = 0, label:FlxSprite, name:String = "", ?callback:Dynamic) {
    ...
    public function set_label(thing:FlxSprite) {
        if (thing != null) {
            thing.x = this.x;
            thing.y = this.y;
