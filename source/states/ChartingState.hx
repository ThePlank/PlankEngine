...
import objects.ChartingBox;
import util.CoolUtil;
import objects.SectionRender;
import classes.Song;
import classes.Song.Event as SongEvent;
...
class ChartingState extends abstracts.MusicBeatState
{
	...
	**/
	...
	function addEventsUI()
	{
			...
			var eventSave = new FlxButton(10,155,"Save Event", function() {
				var pog:SongEvent = new SongEvent(currentSelectedEventName,currentEventPosition,HelperFunctions.truncateFloat(Std.parseFloat(savedValue), 3),savedType);
			...
			var eventAdd = new FlxButton(95,155,"Add Event", function() {
				...
				var pog:SongEvent = new SongEvent("New Event " + HelperFunctions.truncateFloat(curDecimalBeat, 3),HelperFunctions.truncateFloat(curDecimalBeat, 3),_song.bpm,"BPM Change");
